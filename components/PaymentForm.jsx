  ...
  return (
    <div className="flex flex-col items-center w-full pr-20 -ml-8">
      ...
      >
        ...
        <input type="text" name="cvv" placeholder="CVV" className='bg-whitesmoke h-16 rounded-lg px-4' required />
        ...
        <button type="submit" className="mb-4 bg-black rounded-lg h-16 flex items-center justify-center text-white">
        Pay Now $49.98
        </button>
